import torch
from hearline.models.conformers.conformer_block import ConformerBlock
from hearline.models.conformers.repeat import repeat
...
class ConformerEncoder(torch.nn.Module):
    ...
    def __init__(
        ...
        self.conformer_blocks = repeat(
            elayers,
            lambda: ConformerBlock(adim, eunits, aheads, dropout_rate, kernel_size),
        )
